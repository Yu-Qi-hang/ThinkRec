...
class MiniGPT4Rec_v2(Rec2Base):
    ...
    def __init__(
        ...
        if infllm_config is not None and infllm_config.enable:
            from inf_llm.utils import patch_hf
            self.use_cache = True
            self.llama_model = patch_hf(self.llama_model, infllm_config.config.type,  **infllm_config.config)
    ...
    def from_config(cls, cfg):
        ...
        infllm_config = cfg.get("infllm_config", None)
